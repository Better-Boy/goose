...
export const handleSamplingRequest = <ThrowOnError extends boolean = false>(options: Options<HandleSamplingRequestData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<HandleSamplingRequestResponses, HandleSamplingRequestErrors, ThrowOnError>({
